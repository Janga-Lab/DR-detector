...
def plot_learning_curves(estimator, X_train, y_train, X_val, y_val,
    ...
    for i in training_set_sizes:
        ...
        estimator.fit(X_train[0:i, :], y_train[0:i].ravel())
    ...
    ax.plot(training_set_sizes, train_score, c='red',label="Training score",linewidth=3, markersize=12)#c='gold
    ax.plot(training_set_sizes, val_score, c='blue',label="validation score",linewidth=3, markersize=12)#c='steelblue'
    ...
    ax.legend(['Training set', 'Validation set'], fontsize=24, loc='lower right')
